def build_model( # below are default values, but these are all tunable
    input_shape=(512, 512, 3), conv1_filters=32, conv2_filters=64, dense_units=128, use_dropout=True, dropout_rate=0.2, pooling="max",            
):
